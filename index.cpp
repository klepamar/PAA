...
*/
	...
	cout << setw(20) << "BF cas" << setw(15) << "CV cas" << setw(15) << "BB cas" << setw(15) << "DP cas" << setw(10) << "BF cena" << setw(10) << "CV cena" << setw(10) << "BB cena" << setw(10) << "DP cena" << setw(15) << "Rel. chyba CV" << endl;	
	for (int i=0; i<no_of_instances; i++)
	{
		...
		cout << setw(5) << b[i]->getId() << setw(15) << setprecision(5) << bf_time << setw(15) << setprecision(5) << cv_time << setw(15) << setprecision(5) << bb_time << setw(15) << setprecision(5) << dp_time << setw(10) << setprecision(5) << bf_price << setw(10) << setprecision(5) << cv_price << setw(10) << bb_price << setw(10) << dp_price << setw(15) << epsilon << endl;
	}
	epsilon_priemer = epsilon_suma/no_of_instances;
